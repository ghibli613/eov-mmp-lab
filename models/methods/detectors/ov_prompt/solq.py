...
from third_party.detectron2.layers import paste_masks_in_image
from third_party.detectron2.structures import BitMasks
from third_party.detectron2.utils.memory import retry_if_cuda_oom
import torchvision.transforms.functional as TF
from torch import nn

from models.methods.backbones.clip_deit import deit_base as clip_deit_base
from models.methods.backbones.clip_vit_det import local_deit_base as clip_local_deit_base
from models.methods.backbones.deit import deit_tiny, deit_small, deit_base, deit_base_distil
from models.methods.backbones.vit_det import local_deit_base
from models.methods.backbones.vit_det import local_deit_tiny as local_deit_tiny
from models.methods.fpn_fusion import SimpleFeaturePyramid, LastLevelMaxPool
from models.methods.segmentation import (PostProcessPanoptic,
                                  sigmoid_focal_loss, dice_loss)
from models.util import box_ops
from models.util.clip_utils import build_text_embedding_coco, build_text_embedding_lvis
from models.util.coco_categories import SEEN_CATEGORIES as COCO_SEEN_CATEGORIES
from models.util.coco_categories import UNSEEN_CATEGORIES as COCO_UNSEEN_CATEGORIES
from third_party.detectron2.structures import Boxes
from models.util.lvis_v1_categories import SEEN_CATEGORIES as LVIS_SEEN_CATEGORIES
from models.util.lvis_v1_categories import UNSEEN_CATEGORIES as LVIS_UNSEEN_CATEGORIES
from models.util.misc import NestedTensor, inverse_sigmoid, nested_tensor_from_tensor_list
from models.util.misc import (accuracy, get_world_size, is_dist_avail_and_initialized)
...
class SOLQ(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_queries, num_feature_levels,
        ...
        self.clip_feat = torch.load(clip_feat_path, weights_only=False)
