...
from models.util.vidvrd_categories import SEEN_CATEGORIES as VidVRD_SEEN_CATEGORIES
from models.util.vidvrd_categories import UNSEEN_CATEGORIES as VidVRD_UNSEEN_CATEGORIES
from models.util.vidor_categories import SEEN_CATEGORIES as VidOR_SEEN_CATEGORIES
from models.util.vidor_categories import UNSEEN_CATEGORIES as VidOR_UNSEEN_CATEGORIES

# CLIP AUX CLassifier
from third_party.detectron2.structures import Boxes
from models.util.clip_image_encoder import RoIAlignViTImageEncoder
import torchvision.transforms.functional as TF
from models.util.clip_utils import build_text_embedding_coco, build_text_embedding_lvis, build_text_embedding_vidvrd, build_text_embedding_vidor
