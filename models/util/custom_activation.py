...
from models.util.custom_functional import multi_head_attention_forward
...
class MultiheadAttention(Module):
    ...
    def forward(self, query: Tensor, key: Tensor, value: Tensor, key_padding_mask: Optional[Tensor] = None,
                ...
                # new input: indices for cropping rois during self-attention
                roi_indices = None, last = False) -> Tuple[Tensor, Optional[Tensor]]:
        r"""
    Args:
