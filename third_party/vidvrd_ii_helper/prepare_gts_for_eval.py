...
# paths come from utils/paths.py like everywhere else in this repo, so there is
# only ONE copy of the annotations on disk (data/vidvrd/anno/) rather than the
# duplicate tree this file used to point at.
...
def prepare_gts_for_vidor(save_path):
    ...
    dataset = VidOR(
        anno_rpath = "data/vidor/annotations", 
        video_rpath = 'data/vidor/videos/val',  # VidOR val videos (not present)
